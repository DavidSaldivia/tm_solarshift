...
class MERRA2():
    ...
    @classmethod
    def downloader2(cls, dataset: str, file_path: str, verbose: bool = False) -> None: 
    ...
    @classmethod
    def downloader(cls, dataset: str, file_path: str, verbose: bool = False) -> None:                
        list_files = open(file_path, 'r')
        if dataset == "slv":
            keyword1 = 'SERVICE'
    ...
    @classmethod
    def downloader3(cls, dataset: str, file_path: str, verbose: bool = False) -> None:        
...
def main():
    ...
    if False:
        ...
        MERRA2.downloader(dataset, file_path, verbose = True)
    
    if False:
        dataset = "slv"
        file_path = os.path.join(MERRA2.FLDR_DATA_RAW, 'subset_M2T1NXSLV_5.12.4_20240220_183505_.txt')
        MERRA2.downloader2(dataset, file_path, verbose = True)
    
    if False:
        dataset = "slv"
        file_path = os.path.join(MERRA2.FLDR_DATA_RAW, 'subset_M2T1NXSLV_5.12.4_20240220_183505_.txt')
        MERRA2.downloader3(dataset, file_path)
